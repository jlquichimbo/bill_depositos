	...
	<?php echo form_open( $update_url, 'method="post" id="crudForm" autocomplete="off" enctype="multipart/form-data"'); ?>
		...
		<?php }?>
			...
			<div id='report-success' class='report-div success'></div>
                        <div id='edit_new_out' class='col-md-12'></div>
		</div>
		<div class='buttons-box'>
			<div class='form-button-box'>
				<input  id="ajaxformbtn" data-target="edit_new_out" type='submit' value='<?php echo $this->l('form_update_changes'); ?>' class='btn btn-primary' />
			</div>
