...
<div class='form-content form-div'>
	<?php echo form_open( $insert_url, 'method="post" autocomplete="off" enctype="multipart/form-data"'); ?>
		<div>
			<?php
			$counter = 0;
			...
			<div id='add_new_out' class='col-md-12'></div>
		</div>
		<div class='buttons-box'>
			<div class='form-button-box'>
                            <button id="ajaxformbtn" data-target="add_new_out" type='submit' class="btn btn-primary"><?php echo $this->l('form_save'); ?></button>
			</div>
