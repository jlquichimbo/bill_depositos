		...
		<tr  <?php if($num_row % 2 == 1){?>class="erow"<?php }?>>
			...
			<td align="left" width='20%'>
				<div class='tools'>				
                    ...
                    <?php }?>
                    <?php if(!$unset_edit){
                        echo tagcontent('a', '<span class="glyphicon glyphicon-pencil"></span>', array('data-url'=>$row->edit_url,'id'=>'ajaxpanelbtn','data-target'=>'container-fluid','class'=>'edit_button','title'=>$this->l('list_view'),'style'=>'cursor:pointer'));
                        ?>
