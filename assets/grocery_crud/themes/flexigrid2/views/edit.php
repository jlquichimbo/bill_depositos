...
?>
<div class="flexigrid crud-form" style='width: 100%;min-height: 400px' data-unique-hash="<?php echo $unique_hash; ?>">
	<div class="mDiv">
		<div class="ftitle">
...
<div id='main-table-box'>
	...
	<div class="pDiv">
		<div class='form-button-box'>
			...
			<input  id="ajaxformbtn" data-target="report-success" type='submit' value='<?php echo $this->l('form_update_changes'); ?>' class="btn btn-primary"/>
		</div>
