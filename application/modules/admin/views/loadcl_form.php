...
//print_r($clientstipo);
        ...
        echo Open('form',array('method'=>'post','action'=>  base_url().'admin/clients/loadfromfile','enctype'=>'multipart/form-data'));
        
            echo combobox($clientstipo, array('label'=>'tipo','value'=>'idclientetipo'), array('name'=>'clientetipo_id','class'=>''));
