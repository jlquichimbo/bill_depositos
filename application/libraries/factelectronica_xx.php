...
class FactElectronica_xx {
    ...
    */
    function __construct(){
        ...
        $this->url_ws_recepcion = get_settings('SRI_URL_RECEPCION');
        $this->url_ws_autorizacion = get_settings('SRI_URL_AUTORIZACION');
    ...
    public function generar($id_factura) {
        ...
        //print_r($this->url_ws_recepcion);echo '<br>';
        //print_r($this->url_ws_autorizacion);echo '<br>';
...
//        $this->empresa = $this->ci->generic_model->get_by_id('billing_empresa', 8, '', 'id');
...
//        $info_factura->addChild('moneda', '');
    ...
    function guardar_xml($fact_xml) {
        ...
        $el_xml = $dom->saveXML();
        $dom->save($this->path_xml_generado.$fact_xml);
    }
    ...
    public function send_file($fact_xml) {
        $res = $this->webService($this->path_xml_generado.$fact_xml);
        return $res;
    }
